...
datosCoordinador = open(r'C:\Users\NalV\Documents\Definitive_CE_DATA\October\29\c0_1tx_1715.log','r')
datosTransmisor1 = open(r'C:\Users\NalV\Documents\Definitive_CE_DATA\October\29\com4_1tx_1715' , 'r')
#datosTransmisor2 = open(r'C:\Users\NalV\Documents\Definitive_CE_DATA\October\26\com7_3tx_1600' , 'r')
#datosTransmisor3 = open(r'C:\Users\NalV\Documents\Definitive_CE_DATA\Data_BE3\29_3tx_60cm_BE3\com15_BE3_1200' , 'r')

data = datosCoordinador.readlines()
dataTransmisor1 = datosTransmisor1.readlines()
#dataTransmisor2 = datosTransmisor2.readlines()
#dataTransmisor3 = datosTransmisor2.readlines()
...
print("El valor promedio de RSSI para cada transmisor es de :  " ,av1 )
print("Varianza RSSI:", vari_addr1)
print("Desviacion Estandar RSSI", desv1)
...
plt.rcParams.update({'font.weight': 250})
...
plt.plot(datenums1 , values1 ,ls = ':' , lw = 0.1 , c = 'black', marker= '|' , ms = 10 , mec='blue' , label = 'E1')
# plt.plot(datenums2 , values2 ,ls = ':' , lw = 0.1 , c = 'yellow' , marker= '_' , ms = 10 , mec='green', label ='E2')
plt.legend(loc="center right")
plt.xlabel("Time")
plt.ylabel("Events reported by ACK")

## PLOTTING THE RSSI VALUES VS TIMESTAMP RECORDED
...
if  len(rssi_addr1) >0:
    ...
    plt.plot(datenums3 , dbm_addr1 , ls = ':' , lw = 0.1 , c = 'black' , marker= '+' , ms = 10 , mec='blue' , label = 'E1')
    plt.legend(loc="center right")
